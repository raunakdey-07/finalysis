...
export default function ReportPage({
  ...
  if (isLoading) {
    ...
    return (
      <LoadingSpinner
        message={`Analyzing ${router.query.ticker || 'stock'}...`}
      />
    );
  }
  ...
  try {
    ...
    return {
      props: {
        ticker,
        scores: {
          z: { score: NaN, interpretation: '', color: '' },
          f: { score: NaN, interpretation: '', color: '' },
          m: { score: NaN, interpretation: '', color: '' },
          o: { score: NaN, interpretation: '', color: '' },
        },
        explanations: {},
