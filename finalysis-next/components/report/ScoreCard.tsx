  ...
  return (
    ...
    >
          ...
          const normalizedWidth = category.includes('z-score')
            ...
            : category.includes('f-score')
              ...
              : category.includes('m-score')
                ? Math.max(
                    0,
                    Math.min(100, (Math.abs((score as number) + 5) / 8) * 100)
                  ) // M-score inverted
                : category.includes('o-score')
                  ? Math.max(
                      ...
                      Math.min(
                        100,
                        ((2 - Math.min(2, score as number)) / 2) * 100
                      )
                    ) // O-score inverted
      ...
      <Box
        ...
        borderRadius="md"
        borderWidth={1}
        borderColor={theme.insightsBorder}
      >
        <Text
          fontSize="sm"
          color={theme.insightsTitle}
          fontWeight="medium"
          mb={2}
        >
          Key Insights
